...
function coursesReducer(state, action) {
  switch (action.type) {
    ...
    case "SET":
      const reservedData = action.payload.reverse();
      return reservedData;
    case "UPDATE":
      ...
      const updatebleItem = { ...updatableCourse, ...action.payload.data };
      const updateCourse = [...state];
      updateCourse[updatableCourseIndex] = updatebleItem;
      return updateCourse;
    default:
      return state;
  }
